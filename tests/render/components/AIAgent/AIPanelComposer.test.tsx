...
const defaultState = {
  ...
  searchConfig: { enabled: true, provider: 'firecrawl' as const, callMode: 'search_only' as const, maxResults: 10, hasApiKeys: { firecrawl: true, zhipu: false, tavily: false, exa: false } },

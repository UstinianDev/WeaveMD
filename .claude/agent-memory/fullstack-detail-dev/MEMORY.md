...
- [可编辑表格块 M1 编解码](editor-table-m1-codec.md) — tableCodec parse/serialize 契约、每格 trim、SEPARATOR_RE 单列需 /-{3}/ 双判定、与内核独立
- [可编辑表格块 M2 渲染](editor-table-m2-tableblock.md) — 矩阵域=解义文本防双重转义、Enter=下行非 nextCell、jsdom 折叠选区测量坑、行/列删除边界

...
| 编辑主区          | [modules/04-编辑主区-Editor.md](./modules/04-编辑主区-Editor.md)             | 双模式架构（容器级 contentEditable WYSIWYG + 全屏 Monaco 源码）、Block Tree、零宽空格占位、浮动工具栏、跨块选择、代码块语言选择+复制按钮、Minimap、FindReplaceBar、目录导航+动态高亮、可拖拽目录/历史面板宽度、自动保存/撤销重做 |

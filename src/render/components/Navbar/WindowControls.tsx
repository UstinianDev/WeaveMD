  ...
  return (
    <div className="flex items-center h-full no-drag">
      ...
      <button
        ...
        className="w-11 h-full flex items-center justify-center text-[#999999] hover:text-white hover:bg-[#2D2D2D] transition-colors"
        title="Minimize"
      >
      ...
      >
        {isMaximized ? (
          <svg width="12" height="12" viewBox="0 0 12 12">
            ...
            <rect x="0.5" y="3" width="8" height="8" rx="0.5" stroke="currentColor" fill="#1A1A1A" />
          </svg>
        ) : (
          <svg width="12" height="12" viewBox="0 0 12 12">
      ...
      <button
        onClick={handleClose}
        className="w-11 h-full flex items-center justify-center text-[#999999] hover:text-white hover:bg-red-500 transition-colors"
        title="Close"
      >
        <svg width="12" height="12" viewBox="0 0 12 12">

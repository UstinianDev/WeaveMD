...
const RULES: IntentRule[] = [
  {
    intent: 'rewrite',
    // 覆盖书面语 + 口语化表达 + 删除/重命名等文件操作
    keywords: [
      // 书面语
      '修改', '改写', '润色', '缩写', '扩写', '精简', '压缩', '优化', '整理', '美化', '改进',
      // 口语化
      '润一润', '润一下', '改一下', '改一改', '变一下', '调一下', '弄一下', '搞一下',
      '改变', '调整', '变换', '改动', '弄好', '搞好',
      // 删除/丢弃
      '删除', '删掉', '去掉', '丢掉', '扔掉', '丢弃', '清除', '移除', '干掉',
      '删了', '扔了', '丢了', '去掉这个', '删了这个',
      // 重命名
      '重命名', '改名', '换个名字', '改个名',
      // 英文
      'polish', 'rewrite', 'shorten', 'expand', 'summarize', 'paraphrase', 'optimize', 'improve', 'refine', 'clean up', 'delete', 'remove', 'rename',
    ],
  },
  {
    intent: 'kbQa',
  ...
  },
  {
    ...
    keywords: [
      // 书面语
      '写', '创作', '起草', '生成', '写一段', '写一篇', '写个', '写一首', '标题', '文案', '大纲', '故事', 'prompt', '内容', '新建', '创建', '新文件',
      // 口语化：给/要/来/弄/搞 + 文件/笔记/文档
      '给我', '我要', '来一个', '来个', '弄一个', '弄个', '搞一个', '搞个',
      '新笔记', '新文档', '一个文件', '一个笔记', '一个文档',
      '建一个', '建个', '开一个', '开个',
      // 英文
      'write', 'create', 'draft', 'new file', 'new note',
    ],
  },
];
